...
export class IridiumTestWorkflow extends Workflow<IridiumTestWorkflowData> {
  ...
  handlesIridiumTestRecieved ({ iridiumEvent }: IridiumTestRecievedEvent): Partial<IridiumTestWorkflowData> {
    return {
      iridiumEvent
    }
  }
  ...
  async handlesIridiumTestPassed (_: IridiumTestPassedEvent): Promise<Partial<IridiumTestWorkflowData>> {
